<x-app-layout active="categories" workspace="Daily Task Tracker" plan="Task Management">
    ...
    <div class="mt-8 flex flex-wrap items-center justify-between gap-4 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-950">
        ...
        <div class="flex items-center gap-4">
            ...
            <x-buttons.icon variant="outline" data-category-modal-open>
                <x-icons.pencil />
            </x-buttons.icon>
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <div class="mt-3 grid grid-cols-4 gap-3">
                            @foreach (['bg-brand-500', 'bg-amber-500', 'bg-slate-700', 'bg-blue-600', 'bg-violet-500', 'bg-emerald-500', 'bg-rose-500', 'bg-slate-900'] as $color)
                    ...
                    <div class="rounded-2xl border border-slate-200 bg-slate-50 p-4 dark:border-slate-700 dark:bg-slate-900">
                        ...
                        <div class="mt-3 flex items-center gap-3">
                            ...
                            <p class="text-sm font-semibold text-slate-900 dark:text-slate-100">Personal Dev...</p>
                        </div>
                    </div>
                </div>
            </div>
