    ...
    <div class="flex min-h-screen bg-slate-50 dark:bg-slate-950">
        <aside class="hidden w-72 flex-col border-r border-slate-200 bg-white px-6 py-6 dark:border-slate-800 dark:bg-slate-950 lg:flex">
            ...
            <div class="mt-auto space-y-4">
                ...
                <button class="flex w-full items-center gap-3 rounded-xl px-3 py-2 text-sm font-medium text-slate-600 hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-900">
                    <x-icons.settings />
                    Settings
                </button>

                <div class="rounded-2xl bg-slate-100/70 p-4 dark:bg-slate-900">
