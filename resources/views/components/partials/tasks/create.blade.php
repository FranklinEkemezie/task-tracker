{{-- Modal: Create task --}}
<div class="fixed inset-0 z-50 hidden items-center justify-center p-4 sm:p-6 lg:p-8" data-task-modal>
    ...
    >
        ...
        <div class="space-y-6 px-8 py-6">
            <div>
                <label class="text-xs font-semibold uppercase tracking-[0.3em] text-slate-400" for="task-title">Task Title</label>
                <input
                    id="task-title"
                    name="title"
                    type="text"
            ...
            <div class="grid gap-6 md:grid-cols-2">
                <div>
                    <label class="text-xs font-semibold uppercase tracking-[0.3em] text-slate-400" for="task-category">Category</label>
                ...
                <div>
                    <label class="text-xs font-semibold uppercase tracking-[0.3em] text-slate-400" for="task-date">Due Date</label>
                    <div class="relative mt-3">
                        <input
                            id="task-date"
                            name="task_date"
            ...
            <div>
                <label class="text-xs font-semibold uppercase tracking-[0.3em] text-slate-400" for="task-description">Description</label>
                <textarea
                    id="task-description"
                    name="description"
                    rows="4"
            ...
            <label class="flex items-center gap-3 text-sm text-slate-600 dark:text-slate-300">
                <input type="checkbox" name="is_recurring" class="h-4 w-4 rounded border-slate-300 text-brand-500 focus:ring-brand-500" />
                Recurring Task
        ...
        <div class="flex flex-wrap items-center justify-end gap-3 border-t border-slate-200 px-8 py-6 dark:border-slate-800">
            ...
            <x-buttons.primary type="submit" class="px-5 py-2">Save Task</x-buttons.primary>
        </div>
    </form>
</div>
