{{-- Modal: Edit task --}}
<div class="fixed inset-0 z-50 hidden items-center justify-center p-4 sm:p-6 lg:p-8" data-task-edit-modal>
    ...
    <form
        ...
        data-task-edit-form
        data-task-edit-action="{{ route('tasks.update', '[id]') }}"
    >
        @csrf
        @method('PUT')
        ...
        <div class="space-y-6 px-8 py-6">
            <div>
                <label class="text-xs font-semibold uppercase tracking-[0.3em] text-slate-400" for="task-edit-title">Task Title</label>
                <input
                    id="task-edit-title"
                    name="title"
                    type="text"
            ...
            <div class="grid gap-6 md:grid-cols-2">
                <div>
                    <label class="text-xs font-semibold uppercase tracking-[0.3em] text-slate-400" for="task-edit-category">Category</label>
                ...
                <div>
                    <label class="text-xs font-semibold uppercase tracking-[0.3em] text-slate-400" for="task-edit-date">Due Date</label>
                    <div class="relative mt-3">
                        <input
                            id="task-edit-date"
                            name="task_date"
            ...
            <div>
                <label class="text-xs font-semibold uppercase tracking-[0.3em] text-slate-400" for="task-edit-description">Description</label>
                <textarea
            ...
            <label class="flex items-center gap-3 text-sm text-slate-600 dark:text-slate-300">
                <input type="checkbox" name="is_recurring" class="h-4 w-4 rounded border-slate-300 text-brand-500 focus:ring-brand-500" data-task-recurring-input />
                Recurring Task
