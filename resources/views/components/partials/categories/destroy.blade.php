...
<div class="fixed inset-0 z-50 hidden items-center justify-center p-4 sm:p-6 lg:p-8" data-category-delete-modal>
    ...
    <form
        ...
        data-category-delete-form
        data-category-delete-action="{{ route('categories.destroy', '[id]') }}"
    >
        @csrf
        @method('DELETE')
        ...
        <div class="flex flex-wrap items-center justify-end gap-3 border-t border-slate-200 px-6 py-5 dark:border-slate-800">
            ...
            <button type="submit" class="inline-flex items-center justify-center rounded-xl bg-rose-500 px-5 py-2 text-sm font-semibold text-white shadow-sm hover:bg-rose-600">Delete Category</button>
        </div>
    </form>
</div>
